...
set_input_delay 2.0000 -clock [get_clocks {clk_i}] -add_delay [get_ports {en_i}]
...
set_output_delay 2.0000 -clock [get_clocks {clk_i}] -add_delay [get_ports {ovf_o}]
###############################################################################
# Environment
###############################################################################
set_load -pin_load 0.0060 [get_ports {ovf_o}]
...
set_driving_cell -lib_cell sg13g2_buf_4 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {en_i}]
